/*
  ...
  GENERAL INFO:
    ...
    This file creates an instance of `vtboxdec` and decodes some
...
int main(int argc, const char* argv[]) {
  ...
  const char* input_filename = "./test-module-vtbox-encoder.h264";
  ...
  r = tra_core_decoder_create(core, "vtboxdec", &dec_opt, NULL, &dec);
  if (r < 0) {
    r = -40;
    goto error;
  }
...
static int on_decoded_data(uint32_t type, void* data, void* user) {
  ...
  r = snprintf(
    filename,
    sizeof(filename),
    "test-module-vtbox-decoder-image-%s-%04u.yuv",

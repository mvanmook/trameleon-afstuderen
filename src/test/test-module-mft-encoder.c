/*
  ...
  WINDOWS MEDIA FOUNDATION ENCODER TEST
  =====================================

  GENERAL INFO:

    This file creates an instance of the `mftenc` and encodes raw
    NV12 data. The NV12 data is generated using the FFmpeg
    testsrc filter. This file was created during the development
    of the Trameleon library and is used to test the `mft`
    module.
...
int main(int argc, const char* argv[]) {
  ...
  TRAD("Media Foundation Transform Encoder Test");

/*
  ...
  VIDEO TOOLBOX ENCODER TEST
  ===========================

  GENERAL INFO:

    This file creates an instance of the `vtboxenc` and encodes
    raw NV12 data. The NV12 data is generated using the FFmpeg
    testsrc filter. This file was created during the development
    of the Trameleon library and is used to test the `vtbox`
    module.
...
int main(int argc, const char* argv[]) {
  ...
  TRAD("Video Toolbox Encoder Test");
  ...
  fp = fopen("./test-module-vtbox-encoder.h264", "wb");
  if (NULL == fp) {
  ...
  r = tra_core_encoder_create(core, "vtboxenc", &enc_opt, NULL, &enc);
  if (r < 0) {
    r = -80;
    goto error;
  }

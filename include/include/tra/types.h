...
#define TRA_MEMORY_TYPE_H265          0x0005
...
struct tra_memory_image {                                           /* The `tra_memory_image` is often used as input for an encoder that encodes CPU memory. An decoder might output a `tra_memory_image` in e.g. the NV12 format. */
  ...
  uint32_t image_width;                                             /* The width of the image. */
  uint32_t image_height;                                            /* The height of the image. */
...
TRA_LIB_DLL int tra_memory_image_print(tra_memory_image* img);       /* Mostly used during debugging; prints information about the given `tra_memory_image`. */

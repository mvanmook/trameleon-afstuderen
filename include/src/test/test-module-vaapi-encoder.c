/*
  ...
  GENERAL INFO:
    ...
    This file creates an instance of the `vaapienc` and encodes
    raw NV12 data. The NV12 data is generated using the FFmpeg testsrc
    filter.
...
int main(int argc, const char* argv[]) {
  ...
  fp = fopen("./test-module-vaapi-encoder.h264", "wb");
  if (NULL == fp) {
  ...
  r = tra_core_encoder_create(core, "vaapienc", &enc_opt, NULL, &enc);
  if (r < 0) {
    r = -80;
    goto error;
  }
